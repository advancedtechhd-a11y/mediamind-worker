 ...
 */
async function validateImageWithQwen(topic, imageUrl) {
    try {
 ...
 */
export async function validateImageBatch(topic, imageUrls) {
    if (USE_QWEN_FOR_IMAGES) {
        try {
 ...
 */
async function validateImageWithClaude(topic, imageUrl) {
    try {
