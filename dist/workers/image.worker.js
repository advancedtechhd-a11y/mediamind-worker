...
import { validateImageBatch } from '../services/claude.js';
...
export async function processImageResearch(projectId, topic, maxResults) {
    ...
    try {
        ...
        if (FILTER_BY_RELEVANCE && searchResults.length > 0) {
            ...
            const relevantIndices = new Set(relevanceResults
